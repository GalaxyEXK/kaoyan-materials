...
23. 曲线 $y=e^{-\frac{1}{x}}\sqrt{x^{2}-4x+1}$ 的渐近线条数为( ). (A) 1 (B) 2 (C) 3 (D) 4【解析】 $\lim_{x\to 0^{-}}\mathrm{e}^{-\frac{1}{x}}\sqrt{x^2 - 4x + 1} = +\infty$ ，故 $x = 0$ 为铅直渐近线.
...
$$
\begin{array}{r l} & {\underset {x \to - \infty} {\lim} \left(\mathrm{e} ^ {- \frac {1}{x}} \sqrt {x ^ {2} - 4 x + 1} + x\right) = \underset {x \to - \infty} {\lim} \left[ \mathrm{e} ^ {- \frac {1}{x}} (\sqrt {x ^ {2} - 4 x + 1} + x) - x \left(\mathrm{e} ^ {- \frac {1}{x}} - 1\right) \right]} \\ & {\qquad = \underset {x \to - \infty} {\lim} \mathrm{e} ^ {- \frac {1}{x}} \frac {- 4 x + 1}{\sqrt {x ^ {2} - 4 x + 1} - x} - \underset {x \to - \infty} {\lim} x \left(- \frac {1}{x}\right)} \end{array}
$$
